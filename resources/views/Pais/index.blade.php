...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <li class="nav-item" role="presentation">
        <button class="nav-link active" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" aria-selected="false" onclick="window.location.href='http://127.0.0.1:8000/paises'">Paises</button>
    </li>
</ul>
