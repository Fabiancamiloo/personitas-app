...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <li class="nav-item" role="presentation">
        <button class="nav-link active" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false" onclick="window.location.href='http://127.0.0.1:8000/departamentos'">Departamento</button>
    </li>
    <li class="nav-item" role="presentation">
